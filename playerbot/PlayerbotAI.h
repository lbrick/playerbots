...
#include "playerbot/strategy/ExternalEventHelper.h"
#include "playerbot/ChatFilter.h"
#include "playerbot/PlayerbotSecurity.h"
...
public:
    ...
    // New RPG state machine (see playerbot/strategy/rpg/)
    NewRpgInfo     rpgInfo;
