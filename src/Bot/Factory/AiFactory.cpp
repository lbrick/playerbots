...
#include "src/Ai/Base/ReactionEngine.h"

#include "src/Ai/Class/priest/PriestAiObjectContext.h"
#include "src/Ai/Class/mage/MageAiObjectContext.h"
#include "src/Ai/Class/warlock/WarlockAiObjectContext.h"
#include "src/Ai/Class/warrior/WarriorAiObjectContext.h"
#include "src/Ai/Class/shaman/ShamanAiObjectContext.h"
#include "src/Ai/Class/paladin/PaladinAiObjectContext.h"
#include "src/Ai/Class/druid/DruidAiObjectContext.h"
#include "src/Ai/Class/hunter/HunterAiObjectContext.h"
#include "src/Ai/Class/rogue/RogueAiObjectContext.h"
#include "src/Ai/Class/deathknight/DKAiObjectContext.h"
...
void AiFactory::AddDefaultNonCombatStrategies(Player* player, PlayerbotAI* const facade, Engine* nonCombatEngine)
{
    ...
    if (player->InBattleGround())
    {
        ...
        nonCombatEngine->removeStrategy("rpg craft");
        nonCombatEngine->removeStrategy("new rpg");
